...
//            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.earthquake_list_item_2, parent, false);
            listItemView = LayoutInflater.from(getContext()).inflate(R.layout.earthquake_list_item_3, parent, false);
        }
